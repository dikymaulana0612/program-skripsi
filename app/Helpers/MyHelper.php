...
class MyHelper {
    public static function get_avatar($avatar, $empty_if_null = false)
    {
        ...
        if($avatar != NULL)
        {
            ...
            if (!$empty_if_null) {
                return asset('hybrix/assets/images/avatar.png');
            }
        }
    }
    ...
    public static function getStatus($data) {
        switch ($data->status) {
            ...
            case 'paid':
                ...
                break;
            case 'used':
                return '<span class="badge bg-primary">Terpakai</span>';
                break;
            default:
    ...
    public static function getHargaFix($booking)
    {
        if ($booking->user->status_pengunjung == 'Lembaga') {
            return $booking->asset->harga_instansi;
        } else {
            return $booking->asset->harga;
        }
    }
}
