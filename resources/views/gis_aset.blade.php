        ...
        $(document).ready(function() {
                    ...
                    success: function(response) {
                        ...
                        markers1 = response.map(el => {
                            return {
                                ...
                                "nama": el['nama'],
                                "harga": el['harga'],
                                "harga_instansi": el['harga_instansi'],
                                "letak": el['letak'],
                                "asal": el['asal'],
                                "penemu": el['penemu'],
                                "status": el['status'],
            ...
            function addMarker(marker) {
                ...
                var content = `<div class="keterangan">
                        ...
                        <p style="color:black;margin-bottom:2px;">Harga Umum: <span style="color:black"> ${marker.harga} </span></p>
                        <p style="color:black;margin-bottom:2px;">Harga Instansi: <span style="color:black"> ${marker.harga_instansi} </span></p>
                        ...
                        <p></p><img src="${marker.foto1}" style="width:100px;"></p>
                        <p></p><img src="${marker.foto2}" style="width:100px;"></p>
